...
export default function NewEmployee() {
    ...
    try {
      ...
      Object.keys(permissions).forEach((pKey) => {
        Object.keys(permissions[pKey]).forEach((subKey) => {
          formData.append(
            `${pKey}[${subKey}]`,
            String(permissions[pKey][subKey]),
          );
        });
      });
        ...
        <div className="row g-2">
          {Object.keys(state).map((key) => (
            <div key={key} className="col-6 col-md-4 col-lg-3">
              <label
                className={`d-flex align-items-center gap-2 p-2 rounded-2 border bg-white small`}
              >
                <input
                  type="checkbox"
                  name={key}
  ...
  return (
    <div style={{backgroundColor: "#cecef4"}} className="min-vh-100 pb-5">
      <ToastContainer />
        ...
        <div className="container">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div className="d-flex gap-4 mt-3 nav-tabs-custom">
              ...
              <button
                className={`nav-link-btn ${activeTab === "permissions" ? "active" : ""}`}
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-8">
              <div className="card border-0 shadow-sm rounded-4 p-4">
                <h6 className="fw-bold mb-4 border-start border-primary border-4 ps-2">
              ...
              <div className="card border-0 shadow-sm rounded-4 p-4 mt-4">
                <h6 className="fw-bold mb-4 border-start border-success border-4 ps-2">
                  Banking & Payouts
                </h6>
                <div className="row g-3">
                  <div className="col-md-6">
            ...
            <div className="col-lg-4">
              <div className="card border-0 shadow-sm rounded-4 p-4 h-100">
                ...
                <div className="mb-4">
                  ...
                  <div
                    className={`upload-box p-3 border-dashed rounded-3 text-center ${aadharFile ? "border-success" : "border-secondary"}`}
                  >
                    <input
                      type="file"
                      id="up-aadhar"
                      hidden
                      onChange={(e) => setAadharFile(e.target.files)}
                    />
                    <label htmlFor="up-aadhar" className="cursor-pointer mb-0">
                      ...
                      <p className="small mb-0 text-muted">
                        {aadharFile ? aadharFile[0].name : "Upload Aadhaar"}
                      </p>
                    </label>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div
                    className={`upload-box p-3 border-dashed rounded-3 text-center ${panFile ? "border-success" : "border-secondary"}`}
                  >
                    <input
                      type="file"
                      id="up-pan"
                      hidden
                      onChange={(e) => setPanFile(e.target.files)}
                    />
                    <label htmlFor="up-pan" className="cursor-pointer mb-0">
                      ...
                      <p className="small mb-0 text-muted">
                        {panFile ? panFile[0].name : "Upload PAN"}
                      </p>
                    </label>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div
                    className={`upload-box p-3 border-dashed rounded-3 text-center ${drivingFile ? "border-success" : "border-secondary"}`}
                  >
                    <input
                      type="file"
                      id="up-dl"
                      hidden
                      onChange={(e) => setDrivingFile(e.target.files)}
                    />
                    <label htmlFor="up-dl" className="cursor-pointer mb-0">
                      ...
                      <p className="small mb-0 text-muted">
                        {drivingFile ? drivingFile[0].name : "Upload License"}
                      </p>
                    </label>
                  </div>
                </div>
