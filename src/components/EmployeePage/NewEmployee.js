    ...
    <div style={{display:'flex', flexDirection:'column'}}>
      ...
      <h4 style={{borderBottom:'2px solid blue', marginTop:'30px'}}>Employee Permissions And Authorization</h4>
                <div className='mt-2 ms-2'>
                  ...
                  <div className='form-check form-check-inline col-md-2'>
                    <input name='CANCEL_RECEIPT' onChange={handlePaymentIndividualChange} checked={paymentpermission.CANCEL_RECEIPT} className='form-check-input' type='checkbox' id='cancelreceipt' ></input>
