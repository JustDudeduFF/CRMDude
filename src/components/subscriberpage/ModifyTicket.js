  ...
  const handleCloseTicket = async () => {
    ...
    try {
      const response = await axios.put(
        `${api2}/subscriber/ticket/${ticket.ticketno}`,
        {
          ...newticketdata,
        }
      );
          ...
          <form className="row g-3">
            ...
            <div className="col-md-2">
              ...
              <input
                ...
                className="form-control"
                id="inputEmail4"
                defaultValue={ticket.ticketconcern}
                readOnly
              ></input>
            </div>
            <div className="col-md-2">
              <label className="form-label">Ticket Generation Date</label>
              <br></br>
              <input
                type="email"
                className="form-control"
                id="inputEmail4"
                defaultValue={ticket.assigndate}
                readOnly
              ></input>
            </div>
          ...
          <form className="row g-3">
            ...
            <div className="col-md-8">
              ...
              <input
                ...
                type="text"
                className="form-control"
                placeholder="You Take Action On Ticket"
              ></input>
            </div>
          </form>
          <button
