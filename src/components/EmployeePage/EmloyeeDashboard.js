    ...
    <div className="employee-dashboard-wrapper bg-light min-vh-100">
      ...
      <div className="container-fluid p-0">
        <div className="row g-0">
          ...
          <div
            className={`col-lg-3 col-xl-2 employee-sidebar-container ${isSidebarOpen ? "show-sidebar" : ""}`}
          >
            {/* Backdrop for mobile */}
            <div
            ...
            <aside className="employee-sidebar bg-white border-end h-100 d-flex flex-column rounded-0 shadow-sm">
              <div className="p-1 d-flex justify-content-between align-items-center border-bottom bg-white sticky-top">
                <Link
                  to="/dashboard/employees/newemployee"
                  className="btn btn-primary rounded-pill px-4 d-flex align-items-center w-100 justify-content-center d-lg-flex d-none"
                >
                  <UserPlus size={18} />
                  Add New Employee
                </Link>
              ...
              <div className="position-relative mb-1">
                ...
                <input
                  ...
                  className="form-control ps-5 bg-light border-1 py-2 rounded-3 border-primary"
                  ...
                  <ul className="list-unstyled m-1">
                    {filterEmployees.map((emp) => (
                      <li
                        ...
                        className="employee-list-item px-3 py-3 border-bottom d-flex align-items-center justify-content-between cursor-pointer"
                      >
                        <div className="d-flex align-items-center truncate">
                          <div className="avatar-sm bg-primary bg-opacity-10 text-primary rounded-3 p-2 me-3">
                            <User size={20} />
                          </div>
                          <div
          ...
          <div
            ...
            className="col-lg-9 col-xl-10 main-content-area vh-100 overflow-auto"
          >
            {/* Desktop-only Header */}
            ...
            <div style={{ backgroundColor: "#cecef4" }} className="p-1">
              <Routes>
